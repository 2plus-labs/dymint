...
require (
	...
	github.com/2plus-labs/2plus-core v0.0.0-20230809144210-01e4e5936ed1
...
require (
	...
	github.com/tendermint/tm-db v0.6.8-0.20221109095132-774cdfe7e6b0 // indirect
...
replace (
	github.com/2plus-labs/2plus-core => ../2plus-core
